  ...
  return (
    <section className="relative w-full bg-[#ffffff] pt-20 pb-8 px-4 md:px-24">
      ...
      <div className="max-w-7xl mx-auto mb-12">
        <h2 className={`text-5xl font-normal text-[#2E2B28] ${playFair.className}`}>
          Connect with DIANO
        </h2>
      </div>
          ...
          <div className="w-full h-full flex flex-col justify-center min-h-[420px]">
            <form className="space-y-6 flex-1 flex flex-col justify-between">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-normal text-[#333]">First Name*</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-normal text-[#333]">Last Name*</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-normal text-[#333]">Email*</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-sm font-normal text-[#333]">Phone*</label>
                  <input
                    type="tel"
              ...
              <div>
                <label className="block text-sm font-normal text-[#333]">Message*</label>
                <textarea
                  rows={3}
