    ...
    <section className="relative w-full py-16 bg-[#FAF8F2] font-serif text-[#2E2B28] overflow-hidden">
      ...
      <div className="w-full flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center text-center px-4 md:px-0 min-h-[300px]">
          <div>
            <h2 className={`text-3xl md:text-5xl font-normal mb-6 leading-snug ${playFair.className}`}>
              Experience the DIANO<br className="hidden md:block" /> Difference
            </h2>
            <p className={`text-base text-[#3A3836] mb-8 leading-relaxed md:pl-6 md:pr-6 ${inter.className} font-light`}>
